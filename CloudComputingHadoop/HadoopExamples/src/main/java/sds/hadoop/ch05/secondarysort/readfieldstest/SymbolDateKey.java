...
public class SymbolDateKey implements WritableComparable<SymbolDateKey>{
	...
	private int readFieldsCallCount = 0;


	public int getReadFieldsCallCount() {
		return readFieldsCallCount;
	}

	public void setReadFieldsCallCount(int readFieldsCallCount) {
		this.readFieldsCallCount = readFieldsCallCount;
	}
